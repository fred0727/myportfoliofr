  ...
  return (
    <div>
      <div className="w-full dark:bg-gradient-to-r dark:from-slate-900 dark:to-slate-950">
        <section
          id="home"
          className="grid grid-rows-2 xlg:grid xlg:grid-cols-2 xlg:grid-rows-none dark:text-white relative min-h-screen px-10 text-center xlg:px-20 xxl:px-36"
        >
          <div className="flex flex-col justify-center gap-6 xlg:items-start">
            ...
            <div className="hidden xlg:flex justify-center items-center gap-4">
              ...
              <a href="#contact" title="Contactame" alt="Contactame">
        ...
        <section className="w-full py-10 xlg:py-20 xlg:px-10 bg-white dark:bg-transparent">
          <div className="px-6 py-12 flex flex-col gap-5 xlg:gap-16 mx-auto justify-center items-center xxl:max-w-[1850px]">
            ...
            <section className="w-full px-4 gap-8 xmd:gap-20 xlg:gap-24 justify-center grid grid-cols-[repeat(auto-fill,260px)] xxm:grid-cols-[repeat(auto-fill,300px)] xlg:grid-cols-[repeat(auto-fill,350px)]">
              <article className="flex flex-col gap-5 bg-gray-200/40 dark:bg-white hover:bg-slate-200 cursor-pointer transition-all duration-300 shadow-lg px-4 py-4 rounded-md">
              ...
              <article className="flex flex-col gap-5 bg-gray-200/40 dark:bg-white hover:bg-slate-200 cursor-pointer transition-all duration-300 shadow-md px-4 py-4 rounded-md">
                <div className="flex justify-between items-center">
                  <div className="flex gap-2 justify-center items-center">
                    <img
        ...
        <section
          id="projects"
          className="w-full bg-gray-200 dark:bg-slate-950 xlg:py-16 pt-[80px] xlg:pt-[100px]"
        >
          <div className="flex flex-col p-4 py-12 gap-2">
            ...
            <Link to="/projects" className="w-full flex justify-center pt-12">
              <button
                className="text-2xl text-indigo-950 bg-white border-[1px] border-indigo-950 rounded-full px-4 py-1 flex justify-center items-center gap-2 hover:text-white hover:bg-indigo-950 dark:hover:bg-indigo-950 xxs:px-8 xxs:py-2 xxs:text-2xl"
                onClick={redirectPageProject}
              >
                <TfiWorld /> Ver todos
              </button>
            </Link>
        ...
        <section
          id="contact"
          className="bg-white pt-[80px] xlg:pt-[110px] dark:bg-transparent dark:text-white xxl:flex xxl:p-10 xxl:px-10 xxl:flex-row-reverse xxl:w-[1440px] mx-auto"
        >
          <div className="flex flex-col justify-center items-center p-6 gap-4 xmd:w-[650px] mx-auto">
            ...
            >
              <div>
                ...
                >
                  Nombres y Apellidos{" "}
                  <span className="flex text-red-500">*</span>{" "}
                </label>
                <input
                  type="text"
                  name="emailjs_name"
